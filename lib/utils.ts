...
export const systemMessage = `You are an expert AI assistant that helps users structure and optimize their day through deep reasoning and visual planning.
